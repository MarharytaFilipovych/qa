...
class GlobalExceptionHandlerTest {
    ...
    void handleUserAlreadyExists_shouldReturn409() {
        // Arrange
        UserAlreadyExistsException exception = new UserAlreadyExistsException(EXCEPTION);

        // Act
        ResponseEntity<ErrorResponse> response = handler.handleUserAlreadyExists(exception);

        // Assert
        assertErrorResponse(response, EXCEPTION, CONFLICT);
    }
